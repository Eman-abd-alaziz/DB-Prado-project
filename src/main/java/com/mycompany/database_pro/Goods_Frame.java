...
public class Goods_Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8-synchronize-40.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8-show-50.png"))); // NOI18N
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(37, 37, 37)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(Box1, 0, 349, Short.MAX_VALUE)
                                    .addComponent(T5)
        ...
        jLabel8.setBounds(0, 0, 1080, 750);
    ...
    private void ADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ADDActionPerformed
        try {
            ...
            String qur ="insert into prado_company.\"goods\" values("+this.T2.getText()+",'"+this.T1.getText()+"','"+this.T3.getName()+"','"+this.T4.getText()+"',"+this.T5.getText()+",'"+this.Box1.getName()+"')";
  ...
  try {
    ...
    Connection conn = DriverManager.getConnection(connInfo, "eman", "123456");
     ...
     String query = "UPDATE prado_company.\"goods\" "
        + "SET \"name_g\"='" + T1.getText() + "'"
       // + ", \"G_number\"='" + T2.getText() + "'"
        + ", \"color\"='" + T3.getText() + "'"
        + ", \"design\"='" + T4.getText() + "'"
        + ", \"price\"=" + T5.getText() + ""
        + ", \"supplier_country\"='" + Box1.getName()+ "'"     
        //+ " WHERE \"G_number\"='" + T2.getText()"'";  
     
        + " WHERE \"number_g\"='" + (T2.getText()+"'");
   ...
   JOptionPane.showConfirmDialog(null, ex.toString());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       String userInput = JOptionPane.showInputDialog(null, "ENTER THE NUMBER OF GOOD YOU WANT UPDATE ITS DATA :");
    try {
             DriverManager.registerDriver(new org.postgresql.Driver());
            String conINFO ="jdbc:postgresql://localhost:5432/postgres";
            Connection con = DriverManager.getConnection(conINFO,"eman","123456");
           ...
           statment.setString(1,userInput );
             while (rs.next())
             {
             T2.setText(rs.getString("number_g"));
             T1.setText(rs.getString("name"));
             T3.setText(rs.getString("color"));
             T4.setText(rs.getString("design"));
             T5.setText(rs.getString("price"));
             Box1.setName(rs.getString("supplier_country"));}
             rs.close();
              statment.close();
             con.close(); 
        } catch (Exception ex) {
